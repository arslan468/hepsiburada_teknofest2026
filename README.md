...
1.  **Talep Tahmini:** Geçmiş kargo hacim verilerine (desi) dayalı zaman serisi projeksiyonu ile 11–17 Mayıs 2026 haftasına ait günlük talepleri tahmin eder. Projede konsolidasyon yoktur, yalnızca uygun durumlarda uğrama vardır.
...
*  **📉Yol Üstünde Uğrama ile Elde Edilen Finansal & Operasyonel Tasarruf:** 150.807 desi ile elde edilen;

* *Net Finansal Tasarruf:* 345.877,99 TL

* *Oransal Maliyet Kazancı:* %3,41

  

*  **Planlanan Tahmini Desi:** 11-17 Mayıs haftası için tahmin edilen toplam desi 5.102.414 Desidir ancak spot filoda bulunan asgari %10 doluluk limitini sağlamadığı için 50.377 Desilik kısmı için araç ataması yapılamamıştır. Ve 11-17 Mayıs haftası için transferi gerçekleşmesi planlanan net desi 5.052.377'dir.
